...
import { ReplyIcon, ShareIcon, LikeIcon, SaveIcon} from '@/svg/icons'
...
export default function PostReply({props, KeyMutation, user}: {props: PostType, KeyMutation: string, user: UserType}) {
            ...
            <div className="PostContent">
                <div className="minisection" style={{display:'flex', width:'100%' ,flexDirection:'row', justifyContent:'space-between'}}>
                    <div style={{display:'flex', flexDirection:'column',}}>
                        ...
                        {props.ParentPostUsername ? <p id='secondary' style={{fontSize:'11px'}}>Replying to @{props.ParentPostUsername}</p> : null}
                    </div>
                </div>
